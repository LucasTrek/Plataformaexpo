<?php
    ...
    if ($email != '' && $senha != '') {
        ...
        if ($conexao) {
            ...
            $sql = "SELECT * FROM tblogin WHERE usuario = '$email' && senha = '$senha';";
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo "<script>alert('Usuario ou senha incorretos'); window.location.href = 'login1.php';</script>";
            }
        } else {
        ...
        echo "<script>alert('Por favor, preencha todos os campos'); window.location.href = 'login1.php';</script>";
    }
