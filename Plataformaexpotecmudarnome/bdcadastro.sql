...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/10/2023 às 10:00
...
INSERT INTO `tblogin` (`email`, `senha`, `admin`, `id`, `usuario`, `cpf`, `dt_nasc`, `telefone`, `endereco`, `cep`, `numero`) VALUES
...
('s2revenger390@gmail.com', '123', '', 20, 'allan2', 0, '2085-10-03', '', '', '', 0),
('allanfersil@gmail.com', '123', '', 32, 'allan23', 0, '2023-11-19', '', '', '', 0),
('allanfersil@gmail.com', '123', '', 1234, 'azul cristo', 0, '2023-08-30', '', '', '', 0);
...
--
ALTER TABLE `tblogin`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1235;
